package ldh.com.channelmanager.adapter;
...
import ldh.com.channelmanager.ItemDragHelperCallback;
import ldh.com.channelmanager.R;
import ldh.com.channelmanager.activity.MyChannelHeaderWidget;
import ldh.com.channelmanager.activity.MyChannelWidget;
import ldh.com.channelmanager.activity.RecChannelHeaderWidget;
import ldh.com.channelmanager.activity.RecChannelWidget;
import ldh.com.channelmanager.base.EditModeHandler;
import ldh.com.channelmanager.base.IChannelType;
import ldh.com.channelmanager.base.ItemDragListener;
import ldh.com.channelmanager.base.ItemDragVHListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<ChannelAdapter.ChannelViewHolder> implements ItemDragListener {
    private List<ComicSource> mMyChannelItems;
    private List<ComicSource> mOtherChannelItems;
    ...
    public ChannelAdapter(Context context, RecyclerView recyclerView, List<ComicSource> myChannelItems, List<ComicSource> otherChannelItems,
    ...
    public void onItemMove(int fromPosition, int toPosition) {
        if (toPosition > 2) {
            ComicSource item = mMyChannelItems.get(fromPosition - mMyHeaderCount);
    ...
    public class EditHandler extends EditModeHandler {
        @Override
    ...
    private void doStartEditMode(RecyclerView parent) {
        ...
        for (int i = 0; i < visibleChildCount; i++) {
            ...
            if (imgEdit != null) {
                ComicSource item = mMyChannelItems.get(i - mMyHeaderCount);
    ...
    private void moveMyToOther(int position) {
        int myPosition = position - mMyHeaderCount;
        ComicSource item = mMyChannelItems.get(myPosition);
    ...
    private int processItemRemoveAdd(int position) {
        ...
        ComicSource item = mOtherChannelItems.get(startPosition);
    ...
    public interface ChannelItemClickListener {
        void onChannelItemClick(List<ComicSource> list, int position);
    }
